...
def run():
    ...
    dist_folder = os.environ['INPUT_S3-FOLDER']
    ...
    # The below code sets the 'website-url' output 
    # the old ::set-output syntax isn't supported anymore -
    # (that's the only thing that changed though)
